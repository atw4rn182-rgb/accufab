            ...
            <AnimateIn>
              <div className="flex flex-col items-start justify-between gap-8 rounded-sm border border-brand-blue-light/10 bg-charcoal-900/78 px-8 py-10 shadow-xl shadow-black/40 lg:flex-row lg:items-center lg:px-12 lg:py-12">
                <div className="max-w-2xl">
                  <p className="text-sm font-black uppercase tracking-[0.2em] text-brand-blue-light">
                    Start your program
                  </p>
                  <h2
                    id="cta-heading"
                    className="mt-3 text-3xl font-black tracking-tight text-steel-100 drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)] sm:text-4xl"
                  >
                    Ready to Start Your Project?
                  </h2>
                  <p className="mt-4 text-lg font-medium text-steel-300">{COMPANY.tagline}</p>
                </div>
