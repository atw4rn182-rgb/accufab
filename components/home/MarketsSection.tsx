    ...
    >
      <div className="container-narrow">
        <SectionHeading
          ...
          description="From walk-in repairs and one-off fabrications to more involved programs—we support Milan, New Mexico, the Four Corners region, and Texas when schedules, prints, and fit-up expectations need to align."
          align="center"
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <h3 className="text-xl font-black tracking-tight text-steel-100">{market.title}</h3>
